...
with tab1:
    img = st.image("https://github.com/Abdulwahab1313/My-streamlit-web-app-for-my-laptop-business/blob/main/Hp13.jpg",width=200,caption="hp probook touchscreen.keyboardlight,512ssd,8gbram,N400000")
    st.markdown(link)
