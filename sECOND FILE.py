...
with tab1:
    img = st.image("https://raw.githubusercontent.com/Abdulwahab1313/My-streamlit-web-app-for-my-laptop-business/main/Hp13.jpg",width=200,caption="hp probook touchscreen.keyboardlight,512ssd,8gbram,N400000")
    st.markdown(link)
...
with tab6:
    ...
    st.markdown(link)
    with st.expander("click for more photos and details"):
        lists=["Random mini lenovo pc1.jpg","Random mini lenovo pc 2.jpg","Random mini lenovo pc 3.jpg","Random mini lenovo pc 4.jpg","Random mini lenovo pc 5.jpg"]
